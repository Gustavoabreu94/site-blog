...
export const FeatureSection = () => {
  return (
    <section className="container bg-gray-600 grid gap-6 md:grid-cols-2 pb-8 pt-8 md:py-10">
      ...
      <div className="flex flex-col gap-4 rounded-lg bg-gray-500 md:p-12">
        <span className="text-body-tag text-blue-200 bg-blue-400 px-2 py-1 w-fit rounded-sm uppercase">
          Prátcio
        </span>
        <h2 className="text-gray-100 text-heading-lg  font-sans">
